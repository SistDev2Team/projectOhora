						...
						<div
							...
							<ul class="SP_prdListItemInfo" style="display: block;">
								<li class="display_상품명 xans-record- SP_dfList_prdName"><span
									class="title" style=""> <!--<span style="">상품명</span>-->
								</span> <span class="SP_detail_content" style=""><span style="">${ pdtDetail.pdt_name }</span></span>
								</li>
								<li class="xans-record- review_count"><span
									class="SP_detail_content">리뷰 ${ pdtDetail.pdt_review_count }</span></li>
								</li>
								<li class="display_가격 xans-record- SP_dfList_price strike"
									style="display: list-item;"><span class="title" style="">가격</span>
									<span class="SP_detail_content" style=""> <span style="">
											...
											type="hidden" style="">
									</span> <span class="salesPrice">
									<fmt:formatNumber value="${pdtDetail.pdt_discount_amount}" type="number"
												groupingUsed="true" />
									</span> <span class="dcPercent">${ pdtDetail.pdt_discount_rate }%</span></span>
								</li>
								<li class="xans-record- SP_dfList_quantity"
									style="display: list-item;"><span class="title" style="">수량</span>
								...
								<li class="display_할인판매가 xans-record- SP_dfList_salePrice"
									style="display: list-item;"><script>
        // 주문 수량 기능
...
// });
    ...
    </script> <!-- <span class="title" style=""><span style="">할인판매가</span></span><span class="SP_detail_content" style=""><span style=""><span style=""><span id="span_product_price_sale" style="">12,580 </span></span></span></span> -->
								</li>
  ...
  <span class="title" style=""><span style="">배송비</span></span><span class="SP_detail_content" style=""><span style=""><span class="delv_price_B" style=""><input id="delivery_cost_prepaid" name="delivery_cost_prepaid" value="P" type="hidden" style=""><strong>3,000</strong> (50,000 이상 구매 시 무료)</span></span></span>
							...
							<div class="share_btn">
								<span class="kakaoShare" style=""><img
									src="https://cdn-icons-png.flaticon.com/512/1828/1828960.png"></span>
							</div>
						</div>
						<!-------------------------- //상품 정보 호출 ---------------------------->

						<!-------------------------------------- 수량 ---------------------------------->
						<div class="SP_dtQuantity_wrap"></div>
						<!-------------------------------------- 수량 ---------------------------------->
...
// });
						...
						<div id="totalPrice" class="SP_totalPrice">
							<strong>총 상품금액 (개수)</strong> : <span class="total SP_totalPriceNum">
								<strong>
									<em>
                      ...
                      <button type="button" onclick="logoff_sms_restock();" class="xans-element- xans-layout xans-layout-statelogoff btnRestockSms ">재입고 알림 신청하기
									...
									<a href="#none" class="SP_cm_btn SP_btn_black_bg SP_buyBtn ">
										...
										<span id="btnBuy">바로 구매</span> <!-- <span id="btnReserve" class="displaynone">예약주문</span> -->
   ...
   -->
							...
							<div style="margin-top: 40px"
								class="xans-element- xans-layout xans-layout-statelogoff naver_Wrap ">
								<div class="npay_chk_btn"></div>
								<div id="NaverChk_Button">
									<div id="NC_ID_1730038870968324"
										...
										<div id="NPAY_BUTTON_BOX_ID" class="npay_button_box ">
													...
													<tbody>
														<tr>
															<td class="npay_btn_item"><a
																id="NPAY_BUY_LINK_IDNC_ID_1730038870968324" href="#"
															...
															<td class="npay_btn_item btn_width"><a
																id="NPAY_WISH_LINK_IDNC_ID_1730038870968324" href="#"
											...
											<div id="NPAY_EVENT_ID" class="npay_event">
												<a id="NPAY_PROMOTION_PREV_IDNC_ID_1730038870968324"
													href="#" class="npay_more npay_more_prev"><span
													class="npay_blind">이전</span></a>
												<p id="NPAY_PROMOTION_IDNC_ID_1730038870968324"
													class="npay_event_text">
													<strong class="event_title">머니결제혜택</strong><a
														class="event_link"
														href="https://campaign2.naver.com/moneypay/"
														target="_blank" title="새창">최대 3%적립 + 소득공제</a>
												</p>
												<a id="NPAY_PROMOTION_NEXT_IDNC_ID_1730038870968324"
							...
							<div id="NaverChk_Button">
								<div id="NC_ID_1729772615320517"
									...
									<div id="NPAY_BUTTON_BOX_ID" class="npay_button_box ">
										<div class="npay_button">
											...
											<table class="npay_btn_list" cellspacing="0" cellpadding="0">
												<tbody>
													<tr>
														<td class="npay_btn_item"><a
															id="NPAY_BUY_LINK_IDNC_ID_1729772615320517" href="#"
															class="npay_btn_link npay_btn_pay btn_green"
															style="box-sizing: content-box;" title="새창"><span
																class="npay_blind">네이버페이 구매하기</span></a></td>
														<td class="npay_btn_item btn_width"><a
															id="NPAY_WISH_LINK_IDNC_ID_1729772615320517" href="#"
															class="npay_btn_link npay_btn_zzim "
															style="box-sizing: content-box;" title="새창"><span
																class="npay_blind">찜하기</span></a></td>
													</tr>
										...
										<div id="NPAY_EVENT_ID" class="npay_event">
											<a id="NPAY_PROMOTION_PREV_IDNC_ID_1729772615320517" href="#"
												class="npay_more npay_more_prev"><span
												class="npay_blind">이전</span></a>
											<p id="NPAY_PROMOTION_IDNC_ID_1729772615320517"
												class="npay_event_text">
												<strong class="event_title">머니결제혜택</strong><a
													class="event_link"
													href="https://campaign2.naver.com/moneypay/"
											...
											<a id="NPAY_PROMOTION_NEXT_IDNC_ID_1729772615320517" href="#"
                      ...
                      setTimeout(function () {
                        ...
                        $(".npay_btn_pay").one("click", function () {
                          ...
                          if (jgo_products.length > 0 && productTotalPrice > 0) {
							...
							<div class="naver_txt" style="color: #ff0000">
								비회원 네이버페이 구매 시 공식몰 이벤트 혜택이 적용되지 않습니다. <br>자사몰 로그인 후 네이버페이
								결제를 진행하면 이벤트의 혜택 적용이 가능합니다.
							</div>
						</div>
						<!----------------------------- //네이버,카카오 체크아웃 구매 버튼 --------------------------->
					</div>
  ...
  <img src="/web/upload/common/mobile/icon_delv_info.png">이용 안내</th>
                ...
                <strong>총 상품금액 (개수)</strong> : <span class="total SP_totalPriceNum"><strong><em>12,580</em></strong> (1개)</span>
									...
									<!---------------------------------- 상세페이지 배너 ------------------------------------->
									<style>
.detail_ban_wrap, .rolling_banner {
	width: 100%;
	margin: 0 auto;
}
...
.rolling_banner li a img {
	width: 100%;
      ...
      m.parentNode.insertBefore(a, m);
										...
										<script type="text/javascript">window.CAFE24 = window.CAFE24 || {};CAFE24.ROUTE = {"is_mobile":false,"is_need_route":false,"language_code":"ZZ","path":{"origin":"\/coupon\/coupon_productdetail.html","result":"\/coupon\/coupon_productdetail.html","prefix":""},"shop_no":0,"skin_code":"default","support_language_list":{"ar":"ar_EG","ar-EG":"ar_EG","de":"de_DE","de-DE":"de_DE","en":"en_US","en-IN":"en_IN","en-PH":"en_PH","en-US":"en_US","es":"es_ES","es-ES":"es_ES","hi":"hi_IN","hi-IN":"hi_IN","id":"id_ID","id-ID":"id_ID","it":"it_IT","it-IT":"it_IT","ja":"ja_JP","ja-JP":"ja_JP","ko":"ko_KR","ko-KR":"ko_KR","ms":"ms_MY","ms-MY":"ms_MY","pt":"pt_PT","pt-PT":"pt_PT","ru":"ru_RU","ru-RU":"ru_RU","th":"th_TH","th-TH":"th_TH","tr":"tr_TR","tr-TR":"tr_TR","vi":"vi_VN","vi-VN":"vi_VN","zh":"zh_CN","zh-CN":"zh_CN","zh-HK":"zh_HK","zh-MO":"zh_MO","zh-SG":"zh_SG","zh-TW":"zh_TW"}};</script>
	...
	display: none;
																...
																<div class="crema-product-reviews crema-applied"
																	...
																	<iframe id="crema-product-reviews-1" height="0"
																		...
																		frameborder="0"
																		name="crema-product-reviews-1-1729772614950"
																	...
																	<div class="minor displaynone">
																		<p>
																			<img
																				...
																				alt=""> &nbsp;<strong>"19세 미만의 미성년자"</strong>는
																			출입을 금합니다!
																		</p>
																		<p class="button">
																			<a href="/intro/board.html" class="btnEm sizeS">성인인증
																				하기</a>
																		</p>
																	</div>
																	<div class="SP_dtailReveiwBoard_wrap">
																		<table border="1" summary=""
																			class="SP_tableSt01_isThead ">
                        ...
                        <li><a href="#prdQnA">쇼핑안내</a></li> -->
                            ...
                            &nbsp;</div>-->
															...
															<img data-result="success"
																...
																data-size="1000px/1496px" data-filesize="1,31 MB"
																data-error=""
																style="display: block; float: none; vertical-align: top; margin: 0px auto; text-align: center;"
																	...
																	<div class="custom_parts" id="c_parts">
																		<div class="parts_wapper">
																			<div class="parts_thumbnail_box">
																				<img loading="lazy"
																					class="parts parts1 parts_select"
																				...
																				&nbsp;<img loading="lazy" class="parts parts3"
																					onclick="parts('planet_img', 'parts3');"
																					alt="planet" style="width: 15% !important;"
															...
															<div id="product_1304"
																...
																<img loading="lazy" alt=""
																	src="/web/product/basic/01re.jpg"> &nbsp;<img
																	loading="lazy" alt="" src="/web/product/basic/02.jpg">
																&nbsp;<img loading="lazy" alt=""
																	src="/web/product/basic/03ill.jpg"> &nbsp;
																<div
																	class="swiper-container swiper-container-initialized swiper-container-horizontal">
																	<ul class="swiper-wrapper"
																		style="transition-duration: 0ms;">
																		<li class="swiper-slide"><img loading="lazy"
																			alt="" src="/web/product/basic/04-1.jpg"></li>
																		<li class="swiper-slide"><img loading="lazy"
																			alt="" src="/web/product/basic/04-2.jpg"></li>
																		<li class="swiper-slide"><img loading="lazy"
																			alt="" src="/web/product/basic/04-3.jpg"></li>
																		<li class="swiper-slide"><img loading="lazy"
																			alt="" src="/web/product/basic/04-4.jpg"></li>
																	</ul>
																	<div
																...
																<img loading="lazy" alt=""
																	src="/web/product/basic/05re.jpg"> &nbsp;<img
																	loading="lazy" alt="" src="/web/product/basic/06re.jpg">
																&nbsp;<img loading="lazy" alt=""
																	src="/web/product/basic/07re.jpg"> &nbsp;<img
																	loading="lazy" alt="" src="/web/product/basic/08re.jpg">
																&nbsp;<img loading="lazy" alt=""
																	src="/web/product/basic/09rere.jpg"> &nbsp;<img
																	loading="lazy" alt="" src="/web/product/basic/10re.jpg">
																&nbsp;<img loading="lazy" alt=""
																	src="/web/product/basic/11.jpg"> &nbsp;<img
																	loading="lazy" alt=""
																...
																<img loading="lazy" alt=""
																	src="/web/product/basic/13rere.jpg"> &nbsp;<img
																	loading="lazy" alt=""
															...
															<div id="product_1367"
																...
																<div class="swiperBG">
																	<div
																		...
																		<ul class="swiper-wrapper"
																			style="transition-duration: 0ms;">
																			<li class="swiper-slide"><img loading="lazy"
																				alt="" src="/web/product/creampastel/3_1rere.png"></li>
																			<li class="swiper-slide"><img loading="lazy"
																				alt="" src="/web/product/creampastel/3_2rere.png"></li>
																		</ul>
																		<div
																			class="swiper-pagination swiper-pagination-clickable swiper-pagination-bullets"></div>
																		<span class="swiper-notification"
																...
																<img loading="lazy" alt=""
																	...
																	loading="lazy" alt=""
																	src="/web/upload/NNEditor/20220223/10.jpg">

																&nbsp;<img loading="lazy" alt="" class="notice1367"
																	style="display: none;"
																	src="/web/product/creampastel/fix.png"> &nbsp;<img
																	loading="lazy" alt="" class="notice1372"
																	style="display: none;"
															...
															<div id="product_1414"
																...
																<div class="parts_btn">
																	<img loading="lazy" class="mirror_slide"
																		...
																		src="/web/customparts/blossom/bt_1_1.jpg">
																	&nbsp;<img loading="lazy" class="heart_slide"
																		style="width: calc(100%/ 4) !important; display: inline-block; padding: 8px;"
																		src="/web/customparts/blossom/bt_2_2.jpg">
																	&nbsp;<img loading="lazy" class="drop_slide"
																		style="width: calc(100%/ 4) !important; display: inline-block; padding: 8px;"
																		src="/web/customparts/blossom/bt_3_2.jpg">
																	&nbsp;<img loading="lazy" class="flower_slide"
																		style="width: calc(100%/ 4) !important; display: inline-block; padding: 8px;"
      ...
      if(slide_page_url.match("product_no=1137")){
          SP$('#slider-div1').ready(function(){
              SP$('.slick-slider .slick-dots').attr('style', 'width: 900px !important');
															...
															<input type="text" value="OHORA2021DOG"
																id="couponText_dog" readonly=""
																style="display: block; position: absolute; left: -10000px;">
															&nbsp;
															<!-- //쿠폰 코드-->
															<!-- 쿠폰 코드 : 코드 변경 시 value값을 수정해주세요. 고양이-->
															<input type="text" value="OHORA2021CAT"
																id="couponText_cat" readonly=""
																style="display: block; position: absolute; left: -10000px;">
															&nbsp;
															<!-- //쿠폰 코드-->
															<!-- 복사하기 버튼 클릭 시 텍스트 복사 -->
                    ...
                    if (detail_url.match("product_no=" + blockedProductNos[i])) {
                      ...
                      break; // break the loop once the condition is met
												...
												<div class="common_list_container reco_new_container">
													...
													<div
														class="SMS_Product_display SMSprdSortTarget common_list_box"
														data-sort="2col">
														<div
															class="swiper-container swiper-container-initialized swiper-container-horizontal">
      ...
      <use xlink:href="#star-full"></use>
																							...
																							<p class="rv_count">
																								<span class="rv_icon"><img
																									...
																									data-product-code="2106"
																									data-format="{{{count}}}" data-hide-if-zero="1"
																				...
																				<div class="Prev_Cart"
																					onclick="basketConfirmShow(this);">
																					<img
																		...
																		<dl>
																			...
																			<div class="base_img">
																				...
																				<div class="product_icons">
																					<span><img
																						src="/web/upload/custom_3016530263086512.png"
																						alt=""></span><span><img
																						src="/web/upload/custom_3916560421336443.png"
																						alt=""></span>
																				</div>
																				<div class="thumb">
																					<img loading="lazy"
																						class="*lazyload thumb_img swiper-lazy"
																						data-original=""
																						data-src="//www.ohora.kr/web/product/medium/202410/8a09495d30539c30c694a62863d9d620.jpg"
																						alt="" width="800" height="800"><img
																						loading="lazy" decoding="async"
																						class="*lazyload hover_img swiper-lazy"
																						data-original=""
      ...
      <use xlink:href="#star-full"></use>
																...
																<li class="xans-record- append_item swiper-slide"
																	style="width: 323.333px; margin-right: 40px;"><div
																		class="complete container  soldout_prd"
																		data-prd-no="2108" data-filter="#젤네일팁#데일리">
																		<dl>
																			<a
      ...
      <use xlink:href="#star-full"></use>
												...
												<div class="prdDetail_crew not_slide">
													<!--오호라 크루 추천-->
													<div
														class="common_reco_section recommend_crew swiper-container">
														<h3>오호라 크루 추천</h3>
														<div df-banner-code="common-recommend"
															...
															<div df-banner-clone=""
																class="SP_eventBn_li swiper-slide">
																<a
															...
															<div class="SP_detailBoard_wrap">
																...
																<table class="infoTbl">
																	...
																	<tbody>
																		...
																		<tr>
																			<th>배송기간</th>
																			<td><b>[기본 배송]</b><br> <b>* 평일 오후 2시 결제
																					완료 시 당일 출고됩니다. (주말/공휴일 제외)</b><br> <b>* 상품 출고
																					시 송장 번호가 알림톡 또는 SMS로 발송됩니다.</b><br> <b>* 모든
																					배송은 지역 택배사 사정과 천재지변으로 지연될 수 있습니다.</b><br> <b>*
																					배송 폭주, 입고지연, 품절 등으로 인한 미출고 시 별도 안내 드립니다.</b> <br>
																			</td>
																		</tr>
																		<tr>
																			<th>주의사항</th>
																			<td><b>* 주문 내역의 교환/취소/주소지 변경을 원하실 경우 고객센터로
																					연락 바랍니다.</b><br> <b>* 주문 취소를 희망하는 경우 MY PAGE
																					-&gt; 주문 상세정보에서 직접 접수 가능합니다.</b><br> (배송준비중 상태의 주문
																				건을 취소 접수할 경우, 출고 상황에 따라 취소가 거부될 수 있습니다.)<br></td>
																		</tr>
																		<tr>
																			<th>고객센터</th>
																			<td>카카오톡 상담 (@ohora), 게시판 상담 (1:1 문의하기) <br>
																...
																<table class="infoTbl">
																	...
																	<tbody>
																		<tr>
																			<th>교환/반품 신청기준</th>
																			<td><b>&lt;교환/반품 신청이 가능한 경우&gt;</b><br> *
																				단순 변심으로 인한 교환 및 반품은 <b>제품 수령 후 주말 및 공휴일 포함 7일 이내</b>에
																				가능합니다. (배송비 고객부담)<br> * 상품 불량으로 인한 교환 및 반품은 상품
																				공급일로부터 3개월 이내에 가능합니다. (기간엄수)<br> (단, 상품 불량의 경우,
																				고객센터를 통한 불량 검수 후 정상 처리 여부가 결정됩니다.)<br> * 옵션
																				오선택으로 인한 반품 및 교환 시에는 추가 배송비가 발생할 수 있습니다.<br> *
																				상품 불량으로 인한 반품 및 교환을 원하시는 경우, 카톡 플러스친구 상담으로 접수
																				부탁드립니다.<br> (불량 여부 확인 및 제품 품질 개선을 위하여 내용물 사진 등
																				제품에 대한 상세한 정보를 준비 부탁드립니다.)<br> <br> <b>&lt;교환/반품이
																					불가능한 경우&gt;</b><br> * 소비자의 귀책 사유에 의한 상품 훼손(개봉) 및
																				사용에 의해 상품 가치가 현저히 감소한 경우 교환 및 반품이 불가합니다.<br> *
																				교환 및 반품으로 인해 사은품 혜택 기준에 미달되었을 경우, 사은품도 함께 보내주셔야
																				정상적으로 처리 가능합니다.<br></td>
																		</tr>
																		<tr>
																			<th>교환/반품 배송비</th>
																			<td>제품 하자가 아닌 단순 변심에 의한 경우 배송비를 제외한 나머지 금액만 환불
																				처리됩니다.</td>
																		</tr>
																		<tr>
																			<th>교환/반품 접수방법</th>
																			<td>* 교환 및 반품 접수 문의는 고객센터로 연락 부탁드립니다.<br> *
